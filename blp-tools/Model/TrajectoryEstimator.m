...
- (instancetype)init {
    self = [super init];
    if (self) {
        // Load each compiled model from the bundle.
        // Make sure you have these .mlmodel files in your Xcode project,
        // named exactly as shown (minus the .mlmodelc extension).
